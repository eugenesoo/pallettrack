...
*/
var aa=__webpack_require__(3),l=__webpack_require__(9),B=__webpack_require__(4),C=__webpack_require__(1),ba=__webpack_require__(10),da=__webpack_require__(11),ea=__webpack_require__(12),fa=__webpack_require__(13),ia=__webpack_require__(14),D=__webpack_require__(5);
...
_reactDom2.default.render(_react2.default.createElement(_App2.default, null), document.getElementById('app')); /* eslint-env browser */
...
var _AddPallet = __webpack_require__(54);
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.updatePallet = _this.updatePallet.bind(_this);
    _this.updateAllPallets = _this.updateAllPallets.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function getProcesses() {
      ...
      _axios2.default.get('/processes').then(function (data) {
        _this2.setState({
    ...
    value: function getParts() {
      ...
      _axios2.default.get('/parts').then(function (data) {
        _this3.setState({
          partInfo: data.data
        });
      });
    ...
    key: 'updateAllPallets',
    value: function updateAllPallets() {
      var _this4 = this;

      _axios2.default.get('/pallets').then(function (data) {
        _this4.setState({
    ...
    key: 'updatePallet',
    value: function updatePallet(e, palletid, orderid) {
      var _this5 = this;

      _axios2.default.patch('/pallets', {
        palletid: palletid,
        orderid: orderid
      }).then(function () {
        return _this5.updateAllPallets();
      });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'div' },
        _react2.default.createElement(_AddPallet2.default, {
        ...
        _react2.default.createElement(
          'div',
          { className: 'processes' },
          this.state.processInfo.map(function (process) {
            return _react2.default.createElement(_Process2.default, {
              key: process.processid,
              processData: process,
              palletData: _this6.state.palletInfo.filter(function (pallet) {
                return pallet.processid === process.processid;
              }),
              updatePallet: _this6.updatePallet
            });
          })
        )
      );
...
var AddPallet = function (_React$Component) {
  ...
  function AddPallet(props) {
    _classCallCheck(this, AddPallet);

    var _this = _possibleConstructorReturn(this, (AddPallet.__proto__ || Object.getPrototypeOf(AddPallet)).call(this, props));
  ...
  _createClass(AddPallet, [{
    ...
    key: 'createPallet',
    value: function createPallet() {
      var _this2 = this;

      _axios2.default.post('/pallets', {
        palletname: this.state.palletName,
        palletqty: this.state.palletQty,
        palletpart: this.state.partId
      }).then(function () {
        return _this2.props.updateAllPallets();
      });
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.props.partInfo.map(function (part) {
              return _react2.default.createElement(
                'option',
                { key: part.partid, value: part.partid },
                part.partname
              );
            })
          )
...
var Process = function Process(props) {
  return _react2.default.createElement(
    ...
    props.palletData.map(function (pallet) {
      return _react2.default.createElement(
        "div",
        { key: pallet.palletid, className: "pallet" },
        _react2.default.createElement(
          "p",
          null,
          pallet.palletid
        ...
        props.processData.processid !== 7 ? _react2.default.createElement(
          "button",
    ...
    _react2.default.createElement(
      "p",
      null,
      props.palletData.reduce(function (total, pallet) {
        return total += pallet.qty;
      }, 0)
    )
  );
};
